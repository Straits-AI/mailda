...
## What you cannot do, and why — 98 withheld
...
### Operator — running the Node rather than using it (44)
...
- **`getOauthCloudflareCallback`, `getProvider`, `getProviderDeliveryEvents`, `getProviderEmailRouting`, `getProviderHandover`, `getProviderOwnership`, `getProviderSending`, `postProviderAuthorize`, `postProviderResolveAccount`, `postProviderSending`, `postProviderUnselectable`, `putProviderClient`**
