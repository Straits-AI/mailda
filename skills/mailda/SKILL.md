...
## What you cannot do, and why — 100 withheld
...
### Operator — running the Node rather than using it (46)
...
- **`getOauthCloudflareCallback`, `getProvider`, `getProviderDeliveryEvents`, `getProviderDomains`, `getProviderEmailRouting`, `getProviderHandover`, `getProviderOwnership`, `getProviderSending`, `postProviderAuthorize`, `postProviderDomainsCheck`, `postProviderResolveAccount`, `postProviderSending`, `postProviderUnselectable`, `putProviderClient`**
