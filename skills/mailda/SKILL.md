...
## What you cannot do, and why — 93 withheld
...
### Operator — running the Node rather than using it (39)
...
- **`getOauthCloudflareCallback`, `getProvider`, `getProviderEmailRouting`, `postProviderAuthorize`, `postProviderResolveAccount`, `postProviderUnselectable`, `putProviderClient`**
