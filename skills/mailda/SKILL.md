...
## What you cannot do, and why — 94 withheld
...
### Operator — running the Node rather than using it (40)
...
- **`getOauthCloudflareCallback`, `getProvider`, `getProviderDeliveryEvents`, `getProviderEmailRouting`, `postProviderAuthorize`, `postProviderResolveAccount`, `postProviderUnselectable`, `putProviderClient`**
