...
## What you cannot do, and why — 96 withheld
...
### Operator — running the Node rather than using it (42)
...
- **`getOauthCloudflareCallback`, `getProvider`, `getProviderDeliveryEvents`, `getProviderEmailRouting`, `getProviderSending`, `postProviderAuthorize`, `postProviderResolveAccount`, `postProviderSending`, `postProviderUnselectable`, `putProviderClient`**
