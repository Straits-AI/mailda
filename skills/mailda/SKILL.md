...
## What you cannot do, and why — 92 withheld
...
### Operator — running the Node rather than using it (38)
...
- **`getOauthCloudflareCallback`, `getProvider`, `postProviderAuthorize`, `postProviderResolveAccount`, `postProviderUnselectable`, `putProviderClient`**
