...
## What you cannot do, and why — 97 withheld
...
### Operator — running the Node rather than using it (43)
...
- **`getOauthCloudflareCallback`, `getProvider`, `getProviderDeliveryEvents`, `getProviderEmailRouting`, `getProviderOwnership`, `getProviderSending`, `postProviderAuthorize`, `postProviderResolveAccount`, `postProviderSending`, `postProviderUnselectable`, `putProviderClient`**
