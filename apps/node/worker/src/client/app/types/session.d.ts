 ...
 * `src/client/session.client.js`, and the reason it stays out of the bundle is the `external:` list in
 * `scripts/build-client.mjs`. Mapped onto the specifier `/app/session.js` by
