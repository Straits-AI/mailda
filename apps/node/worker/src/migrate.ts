...
import m0041 from "../migrations/0041_body_search.sql";
import m0042 from "../migrations/0042_recovery_code_strength.sql";
import m0043 from "../migrations/0043_recovery_code_confirmation.sql";
...
import m0048 from "../migrations/0048_body_index_lease.sql";
import m0049 from "../migrations/0049_recovery_restores.sql";
import m0050 from "../migrations/0050_restore_ownership.sql";
import m0051 from "../migrations/0051_recovery_conflict_acknowledgements.sql";
...
import m0056 from "../migrations/0056_quarantine.sql";
...
import m0065 from "../migrations/0065_attachment_limits.sql";
...
const MIGRATIONS: ReadonlyArray<{ name: string; sql: string }> = [
  ...
  { name: "0041_body_search.sql", sql: m0041 },
  { name: "0042_recovery_code_strength.sql", sql: m0042 },
  { name: "0043_recovery_code_confirmation.sql", sql: m0043 },
  ...
  { name: "0048_body_index_lease.sql", sql: m0048 },
  { name: "0049_recovery_restores.sql", sql: m0049 },
  { name: "0050_restore_ownership.sql", sql: m0050 },
  { name: "0051_recovery_conflict_acknowledgements.sql", sql: m0051 },
  ...
  { name: "0056_quarantine.sql", sql: m0056 },
  ...
  { name: "0065_attachment_limits.sql", sql: m0065 },
];
