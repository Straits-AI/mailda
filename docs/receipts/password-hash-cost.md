...
Argon2id is the better algorithm: memory-hard, so it resists GPU and ASIC attack in a way PBKDF2
...
- `auth.refresh_token_ttl_seconds = 2592000`: thirty days, DB-backed and therefore
